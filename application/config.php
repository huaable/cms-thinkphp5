...
return [
    ...
    'wechat' => [
        'appId' => 'wx1fcf87b6d43fdbb4',
        'appSecret' => '058921a8a2e75baf2d6ccb806cc4e448',
        'token' => 'huaable',
        'encodingAesKey' => '',
    ],
...
//        'encodingAesKey' => 'n8iqub0ScwWpmYP1ZNQThxOhEL9KwXGMkrB5X7AL1B0',
    ...
    'qywx' => [
        ...
        "corpId" => "ww91a61e844643ffac",
        "secret" => "pX7E0_pAFHZcmSfsONBsYB0F9vCs2cRXYSOqSOG-QNY",

        "token" => "zD753IkwTfDBRdtrPycEBXHDyb0",
        "encodingAesKey" => "9jDMjbLW32YVP9BaLExHIrEQSNxZE3tjHAtBoCG4Reh",

        // "通讯录同步"应用的secret, 开启api接口同步后，可以在管理端->"通讯录同步"看到
//        "CONTACT_SYNC_SECRET" => "9jDMjbLW32YVP9BaLExHIrEQSNxZE3tjHAtBoCG4Reh",

        // 某个自建应用的id及secret, 在管理端 -> 企业应用 -> 自建应用, 点进相应应用可以看到
        "agentId" => 1000002,
        "appecret" => "6Ww-BXlYapJyfly0qp2c8iF6dci6lDS25ZsffXtwPTw",
