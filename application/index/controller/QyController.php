...
/**
 * Class QyWeixinController
 * @package app\index\controller
 */
class QyController extends CommonController
{

    public function token()
    {
        require_once EXTEND_PATH . "/weworkapi/callback/WXBizMsgCrypt.php";
